 ...
 * @param styleName The style name (e.g., "Techno & Raver").
 * @returns The fallback prompt string.
 */
function getFallbackPrompt(styleName: string): string {
    return `Create a photograph of the person in this image in the style of the ${styleName} subculture from 1990s Germany. The photograph should capture the distinct fashion, hairstyles, and overall atmosphere of that time period. Ensure the final image is a clear photograph that looks authentic to the era.`;
}
 ...
 * @param styleName The name of the style, used for generating a fallback prompt.
 * @returns A promise that resolves to a base64-encoded image data URL of the generated image.
 */
export async function generateStyledImage(imageDataUrl: string, prompt: string, styleName: string): Promise<string> {
